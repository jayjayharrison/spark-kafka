...
object DegreesOfSeparation {
  ...
  val startCharacterID = 100 
  val targetCharacterID = 12 
  ...
  def createStartingRdd(sc:SparkContext): RDD[BFSNode] = {
    val inputFile = sc.textFile("dataset/SparkScala3/SparkScala3/Marvel-graph-sample.txt")
  ...
  def bfsMap(node:BFSNode): Array[BFSNode] = {
    ...
    if (color == "GRAY") {
      for (connection <- connections) {
        ...
        val newDistance = distance + 1 //0+1
        val newColor = "GRAY"
